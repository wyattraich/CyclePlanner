    ...
    def train(self, epochs, batch_size=1, sample_interval=50):
        ...
        for epoch in range(epochs):
            for batch_i, (imgs_A, imgs_B) in enumerate(self.data_loader.load_batch(batch_size)):
                ...
                fake_B = self.g_AB.predict(imgs_A) #feed in map to generate path
...
if __name__ == '__main__':
    ...
    #"""
    """
    model = load_model("saved_model/gen_model3.h5", custom_objects={'InstanceNormalization': InstanceNormalization})

    a = DataLoader("path",img_res=(256, 256))

    img_test = a.load_data(domain="A",batch_size=1, is_testing=True)
